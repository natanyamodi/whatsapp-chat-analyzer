...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        ax.set_xticks(ax.get_xticks()[::2])  # Show every alternate month to reduce clutter
        ...
        fig, ax = plt.subplots(figsize=(12, 6))  # Increase figure size
        ax.plot(daily_timeline['only_date'], daily_timeline['message'], color='pink', marker='o', linestyle='-')
